...
```bash
python skills/codex-fable5/scripts/codex_goals.py create --brief "Add CSV import" \
...
python skills/codex-fable5/scripts/codex_goals.py next
python skills/codex-fable5/scripts/codex_goals.py checkpoint --id G001 --status complete --evidence "Read importer.ts and import.test.ts"
python skills/codex-fable5/scripts/codex_goals.py next
```
